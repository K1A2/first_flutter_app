...
class MyApp extends StatelessWidget {
  static const String _title = 'Widget Exemple';
...
class WidgetApp extends StatefulWidget {
  ...
  @override
  _WidgetExempleState createState() => _WidgetExempleState();
}

class _WidgetExempleState extends State<WidgetApp> {
  String sum = '';
                  ...
                  child: Row(
                    ...
                    onPressed: () {
                      setState(() {
                        var result;
                        if (_buttonText == '더하기') {
                          result = int.parse(value1.value.text) + int.parse(value2.value.text);
